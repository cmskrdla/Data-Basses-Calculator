...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' btnDelete
        ' 
        btnDelete.Location = New Point(252, 120)
        ...
        ' BtnNelly
        ' 
        BtnNelly.Location = New Point(175, 168)
        BtnNelly.Margin = New Padding(3, 2, 3, 2)
        BtnNelly.Name = "BtnNelly"
        BtnNelly.Size = New Size(77, 22)
